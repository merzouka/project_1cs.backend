...
from .views import check_tirage_definition, fetch_winners, participants_tirage, registration,associate_tirage_with_baladiyas,baladiya_names_by_utilisateur, tirage_fini,winners_by_baladiya,visite_status
from . import views
urlpatterns = [
