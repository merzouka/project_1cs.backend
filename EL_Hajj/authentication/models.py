...
class elHadj(AbstractBaseUser):
    ...
    province = models.IntegerField(choices=CHOICES)
    STATUS_CHOICES = {
    'H': 'Homme',
    'F': 'Femme',
}
    gender = models.CharField(max_length=1, choices=STATUS_CHOICES, default='H',blank=False)
